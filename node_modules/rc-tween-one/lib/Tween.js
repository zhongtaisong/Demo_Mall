...
var Tween = function Tween(target, to, attr) {
  var toData = (0, _util.dataToArray)(to);
  this.target = target;
...
p.getAnimStartData = function (item) {
  ...
  Object.keys(item).forEach(function (_key) {
    if (_key in _plugins2['default'] || _this3.attr === 'attr' && (_key === 'd' || _key === 'points')) {
      _this3.computedStyle = _this3.computedStyle || (!_this3.target.getAttribute ? (0, _extends3['default'])({}, _this3.target) : _this3.getComputedStyle());
  ...
  Object.keys(endData.vars).forEach(function (_key) {
    ...
    if (_this5.attr === 'attr') {
      ...
      if (!endVars.type) {
        ...
        _this5.setValue(_key, (0, _styleUtils.getColor)(data));
      }
    }
  });
